...
class CharacterTableSeeder extends Seeder {
    ...
    public function run()
    {
        DB::table('characters')->insert(array(
			array('name' => 'Jolan', 'class' => 'Stalker','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Daeke', 'class' => 'Warrior','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Gruff', 'class' => 'Engineer','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Gilby', 'class' => 'Esper','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Kyior', 'class' => 'Spellslinger','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Plumpo', 'class' => 'Medic','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'DruZod', 'class' => 'Stalker','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Talvon', 'class' => 'Warrior','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Xinit', 'class' => 'Engineer','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Random', 'class' => 'Esper','role'=>'tank','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Folkmore', 'class' => 'Spellslinger','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Lisassa', 'class' => 'Esper','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Churchill', 'class' => 'Spellslinger','role'=>'heal','ep' => rand(0,1000),'gp' => rand(0,1000))
		));
        DB::table('characters')->insert(array(
			...
			array('name' => 'Isaias', 'class' => 'Stalker','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Celia', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Tamica', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Isidra', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Suzanna', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Katy', 'class' => 'Medic','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Bruce', 'class' => 'Stalker','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Bryan', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Bernardo', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Corey', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Zack', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Noe', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Wade', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Armando', 'class' => 'Medic','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Donovan', 'class' => 'Stalker','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Williams', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Rolando', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Jay', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Octavio', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Xoolia', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Olivander', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Boondock', 'class' => 'Medic','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Shaldirn', 'class' => 'Stalker','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Runlevel6', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Grufftech', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Malgus', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Vossryn', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Boner', 'class' => 'Esper','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Soup', 'class' => 'Spellslinger','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Cheez', 'class' => 'Medic','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Jolly', 'class' => 'Stalker','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Easter', 'class' => 'Warrior','ep' => rand(0,1000),'gp' => rand(0,1000)),
			array('name' => 'Taunts', 'class' => 'Engineer','ep' => rand(0,1000),'gp' => rand(0,1000)),
		));
    }
}
