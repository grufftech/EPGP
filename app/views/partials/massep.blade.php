<!-- start reg widget -->
<div class="jarviswidget jarviswidget-color-darken jarviswidget-sortable" id="wid-id-massep" data-widget-editbutton="false" data-widget-deletebutton="false" role="widget" style="">
	<!-- widget options:
		...
		<div class="widget-body">
			<div class="widget-body no-padding">
				...
				{{Form::open(array('action' => 'AdminController@massEffort','class'=>'smart-form'))}}
					<header>
						Characters to Award Mass EP
					</header>

					<fieldset>
						<div class="row">
							<?php foreach ($alphaCharacters as $toon){?>
