...
<div class="jarviswidget jarviswidget-color-darken jarviswidget-sortable" id="wid-id-jabtest" data-widget-editbutton="false" data-widget-deletebutton="false" role="widget" style="" data-widget-colorbutton="false">
	...
	<div role="content">
		...
		<div class="widget-body">
			...
			<div class="row">
				{{Form::open(array('action' => 'AdminController@scrape'))}}
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="input-group">
										...
										{{ Form::text('url','',array('class'=>'form-control ','placeholder'=>'http://wildstar.datminer.com/item/40094/Project_Legacy:_The_Contrarian'));}}
